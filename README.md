...
| ٤ | **العاصفة الرملية** | كل بضع دقائق: مدى الأبراج ‎−٣٠٪، الإنتاج يقف إلا بمصدّات رياح. المهاجم الذكي يهجم أثناءها. |
...
- **١٢ مهمة حملة** تعلّم كل واحدة آلية جديدة، من «أول الغزاة» إلى «ما بعد الرمال»
...
| المسار | المحتوى |
|---|---|
| `kingdoms/<pid>` | لقطة القاعدة والاسم والكؤوس (بضعة كيلوبايتات بعد الضغط) |
