> **مشاريع هذا المستودع**
> * [`index.html`](index.html) — **صوتك · Sawtak**: استوديو الدبلجة الذكي (هذا الملف).
> * [`awlam.html`](awlam.html) — **عوالم · AWLAM**: منصّة ومحرّك ألعاب ثلاثي الأبعاد — [الدليل الكامل](AWLAM.md).
